...
// Fix: Add types + make className optional
    ...
    <section className="py-25 bg-[#f5f9fa] -mt-20 sm:py-24-50/70">
      <div className="ml-20 p-20 rounded-2xl bg-white max-w-[1280px] mx-auto shadow-[10px_10px_20px_rgba(0,0,0,0.1)]">
        <div className="flex justify-between items-center">
          ...
          <p>
            Design a function operating system that works for <br /> your business and
            streamlined cash flow <br /> management
          </p>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-10">
          <div className="p-6">
            ...
            <p className="mt-2 text-gray-500">
              Send and receive money with zero fees, no matter where you are.
            </p>
          </div>
          ...
          <div className="p-6">
            ...
            <p className="mt-2 text-gray-500">
              Manage all your business and personal accounts from one dashboard.
            </p>
          </div>
