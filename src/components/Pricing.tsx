const Pricing = () => {
  return (
    <>
         ...
         <small className="text-[#012534] font-bold block text-center mb-10 ">CHOOSE PLAN:</small>
            <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-8 items-stretch">
                <div className="bg-[#eff5f5] py-16 p-8 rounded-2xl flex flex-col">
                    ...
                    <p className="mt-8 text-4xl font-bold text-[#0D2B3E]">$2.99<span className="text-lg font-normal text-gray-500">/month</span></p>
                </div>
                <div className="bg-gradient-to-br py-16 from-[#2a8e9e]  to-[#2DD4BF] text-white p-8 rounded-2xl flex flex-col relative overflow-hidden shadow-2xl shadow-teal-500/30">
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                        ...
                        <p className="mt-8 text-4xl font-bold">$24.99<span className="text-lg font-normal opacity-80">/month</span></p>
                    </div>
                </div>
            </div>
        </section> 
